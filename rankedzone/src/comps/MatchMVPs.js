                    ...
                    <Grid item xs={12} md={mode != "br_brsolo" ? 6 : 12}>
                        <Paper elevation={0} style={{ marginBottom: "10px" }}>
                            <Grid container direction="row" alignItems="stretch" justify="flex-start">
                                <Grid item xs={12}>
                                    <Grid container direction="column" alignItems="center" justify="center" style={{ color: "white" }}>
                                        <Grid container item xs={12} alignItems="center" justify="center" style={{ background: "#353535", borderTopRightRadius: "3px", borderTopLeftRadius: "3px" }}>
                                            <h4 style={{ margin: 8 }}>
                                                TOP TEAM KILLS
                                            </h4>
                                        </Grid>
                                        <Grid container item xs={12} direction="row" alignItems="center" justify="flex-start" style={{ background: "#4d4d4d" }}>
                                            <Grid item xs={1}>
                                        ...
                                        <Grid container item xs={12} direction="row" alignItems="center" justify="flex-start" style={{ background: "#4d4d4d", borderBottomLeftRadius: "3px", borderBottomRightRadius: "3px" }}>
                                            <Grid item xs={1}>
